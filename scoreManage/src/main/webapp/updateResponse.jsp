...
<%
    ...
    try {
        ...
        stmt.setInt(2, score.getMathScore());
        stmt.setInt(3, score.getEnglishScore());
        stmt.setInt(4, score.getProgramScore());
        stmt.setInt(5, score.getDatabaseScore());
        stmt.setString(6, score.getId());
